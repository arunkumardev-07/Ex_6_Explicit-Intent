...
Create a new Android project in Android Studio and name it ExplicitIntentExample.

Design the first activity (MainActivity):

Open activity_main.xml.

Add a Button with the text "Go to Second Activity".

Design the second activity (SecondActivity):

Create a new Activity named SecondActivity.

In activity_second.xml, add a TextView to display a message (for example, “Welcome to Second Activity!”).

Write code for the MainActivity:

In MainActivity.java, find the button using findViewById().
